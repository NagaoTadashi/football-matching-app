...
const games = [
    {
        img: 'https://images.pexels.com/photos/41257/pexels-photo-41257.jpeg?auto=compress&cs=tinysrgb&w=800',
        title: 'レアル・マドリード',
        date: '2024/5/8',
        time: '13:00',
        venue: 'スタジアム',
    ...
    {
        img: 'https://images.pexels.com/photos/18420917/pexels-photo-18420917.jpeg?auto=compress&cs=tinysrgb&w=800',
        title: 'インテル',
        date: '2024/5/8',
        time: '13:00',
        venue: 'スタジアム',
                ...
                <v-row dense>
                    ...
                    >
                        <v-card class="pb-3" border flat>
                            ...
                            <v-card-item>
                                <v-card-title
                                    >vs {{ item.raw.title }}</v-card-title
                                >
                                <br />
                                <v-card-subtitle>
                                    日時：{{ item.raw.date }}
                                ...
                                >
                                <v-card-subtitle>
                                    場所：{{ item.raw.venue }}</v-card-subtitle
                                >
                            </v-card-item>
